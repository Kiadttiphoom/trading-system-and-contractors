  ...
  border: 0.5px solid;
    ...
    <table id="dataTable" class="table table-striped table-hover" >
            ...
            <thead style="background-color:#f26b5f;">
                <tr class="" >
                    <th hidden><center><font size=2 color=#FFFFFF><b>ลำดับ</b></font></center></th>
                    ...
                    <th><center><font size=2 color=#FFFFFF><b>จำนวน</b></font></center></th>
                    <th><center><font size=2 color=#FFFFFF><b>ราคา</b></font></center></th>
                    <th><center><font size=2 color=#FFFFFF><b>ราคารวม</b></font></center></th>
           ...
           <?php
            ...
            <?php
                    $sql = " SELECT buy.no_buy , buy.id_receipt_buy , product.name_product, buy.buy_number,buy.price_buy, buy.total_buy,buy.status
                    FROM buy 
                    INNER JOIN product  on buy.id_product  = product .id_product  Where id_receipt_buy='$id_receipt_buy'";
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      ...
                      <tr>
                          <td hidden><center><font size=2 color="#000"><b><?php echo $row['no_buy']; ?></b></font></center></td>
                          ...
                          <td><center><font size=2 color="#000"><b><?php echo $row['buy_number']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['price_buy']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['total_buy']; ?></b></font></center></td>
                          <td class="text-center" ><font size=2><b><!-- <a href="buy_change.php?Action=Change&id_receipt_buy=<?php echo $row['id_receipt_buy']; ?>" onclick="return confirm('ยืนยันการเปลี่ยนสถานะ')"> -->
                                ...
                                <td><center><a href="buy_detail_edit.php?no_buy=<?php echo $row['no_buy']; ?>"><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                            class='fas fa-edit far-lg'></i></button></a> 
                        <a href="data_delete.php?del_buy_detail=<?php echo $row['no_buy']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
                     ...
                     <?php endwhile ?>
                                        ...
                                        <center><a href="/project/employee/buy.php" class="btn btn-warning" type="button" style="width:13%">กลับ</a></center>
                                        <br>
    </div>
                                </div>

  ...
  border: 0.5px solid;
    ...
    <table id="dataTable" class="table table-striped table-hover" >
            ...
            <thead style="background-color:#f26b5f;">
                <tr >
                    <th><center><font size=2 color=#FFFFFF>เลขที่ใบเสร็จซื้อ</font></center></th>
            ...
            <?php
                    $sql = " SELECT delivery.no_delivery , delivery.id_receipt_delivery , product.name_product, delivery.delivery_number,delivery.price_delivery, delivery.total_delivery,delivery.status
                    FROM delivery 
                    INNER JOIN product  on delivery.id_product  = product .id_product  Where id_receipt_delivery='$id_receipt_delivery'";
            ...
            ?> 
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      ...
                      <tr>
                          ...
                          <td><center><font size=2 color="#000"><b><?php echo $row['delivery_number']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['price_delivery']; ?></b><?php echo "&nbspบาท" ?></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['total_delivery']; ?></b><?php echo "&nbspบาท" ?></font></center></td>
                          <td class="text-center"><font size=2><b><n><a href="delivery_detail_change.php?Action=Change&no_delivery=<?php echo $row['no_delivery']; ?>" onclick="return confirm('ยืนยันการเปลี่ยนสถานะ')">
                                <?php if($row ['status']=='1'){ 
                                    echo "<font color=\"orange\">รอส่ง</font>";
                                    }
                                    elseif($row ['status']=='0') { 
                                        echo "<font color=\"green\">ส่งสำเร็จ</font>";
                                    }
                                    elseif($row ['status']=='3') { 
                                        echo "<font color=\"green\">ส่งไม่สำเร็จ</font>";
                                    }  
                                    else { 
                                ...
                                <td><center><a href="delivery_detail_edit.php?no_delivery=<?php echo $row['no_delivery']; ?>"><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                            class='fas fa-edit fa-lg'></i></button></a> 
                        <a href="data_delete.php?del_delivery_detail=<?php echo $row['no_delivery']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
                     ...
                     <?php endwhile ?>
                                        ...
                                        <center><a href="/project/employee/delivery.php" class="btn btn-warning" type="button" style="width:13%">กลับ</a></center>
                                        <br>
    </div>
                                </div>

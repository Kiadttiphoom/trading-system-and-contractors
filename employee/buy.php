            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow-lg mb-4">
                                ...
                                <a href="/project/employee/buy_add.php" class="btn btn-success pull-right" type="button" style="width:%"><i class="fa fa-plus" aria-hidden="true"></i> เพิ่มข้อมูลซื้อสินค้า</a>
                <!-- Fixed header table-->
    ...
    <table id="dataTable" class="table table-striped table-hover" >
            ...
            ?>    
                      ...
                      <tr>
                          ...
                          <td><center><font size=2 color="#000"><b><?php echo $row1['grand_buy']; ?></font></b></center></td>

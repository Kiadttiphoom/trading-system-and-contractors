            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold "><font color="#000">แก้ไขข้อมูลบริษัท</font></h5></center>                           
                                </div>
                                <!-- Card Body -->
...
if (isset($_POST['update_company'])) {
    ...
    $sql_company = $updatedata->update_company($name_company, $tel_company, $provinces, $amphures,$districts, $zip_code, $address_company, $email_company ,$userid);
    if ($sql_company) {
        echo "<script>alert('แก้ไขข้อมูลบริษัทเรียบร้อย!');</script>";
        echo "<script>window.location.href='company.php'</script>";
    } else {
        echo "<script>alert('บางอย่างผิดพลาด กรุณาลองอีกครั้ง!');</script>";
        echo "<script>window.location.href='company_edit.php'</script>";
    }
}
...
$sql_company = $updateuser->fetchonerecord_company($userid);
while($row = mysqli_fetch_array($sql_company)) {
?>
...
<table style="width:100%" class="text-center"> 
            ...
            <tr>
                <div class="mb-3 ">
                        ...
                        <td style="width:5%"><input type="text" class="form-control text-center" name="id_company" value="<?php echo $row['id_company']; ?>" required readonly style="width:100%"></td>
                        <td style="width:5%"><label for="name_company" class="py-3"><font color="#000"><b>ชื่อบริษัท<b></font></label></td>
                        <td colspan="2"><input class="form-control text-center" name="name_company" type="text" id="name_company" value="<?php echo $row['name_company']; ?>" class="form-control" placeholder="ชื่อบริษัท" aria-describedby="text" required style="width:100%"/></td>
                </div>
            </tr>
            ...
            <tr> 
                    ...
                    <td style="width:10%"><input value="<?php echo $row['tel_company']; ?>" class="form-control text-center" type="text" name="tel_company" id="tel_company" placeholder="เบอร์โทรศัพท์"></td>
                    <td style="width:5%"><label for="zip_code" class="py-3"><font color="#000"><b>อีเมล<b></font></label></td>
                <td colspan="2" style="width:10%"><input value="<?php echo $row['email_company']; ?>" class="form-control text-center" type="email" name="email_company" id="email_company" ></td>
                </div>
            </tr>
            <tr> 
...
<td colspan="3" style="width:10%"><textarea value="" input class="form-control text-center" name="address_company" type="text" id="address_company" class="form-control" placeholder="ที่อยู่" aria-describedby="text" required style="width:"><?php echo $row['address_company']; ?></textarea></td>
        ...
        <br>
        <center><button type="submit" name="update_company" class="btn btn-success">แก้ไขข้อมูลลูกค้า</button>

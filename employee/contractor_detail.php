  ...
  border: 0.5px solid;
    ...
    <table id="dataTable" class="table table-striped table-hover" >
            ...
            <thead style="background-color:#f26b5f;">
                <tr >
                    <th hidden><center><font size=2 color=#FFFFFF>ลำดับ</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>เลขที่รับเหมา</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>ชื่อชนิดงาน</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>กว้าง</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>สูง</font></center></th>
            ...
            <?php
                    ...
                    FROM contractor 
                    INNER JOIN type_work  on contractor.id_type_work  = type_work.id_type_work  Where id_receipt_contractor ='$id_receipt_contractor'";
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                        <td hidden><center><font size=2 color="#000"><b><?php echo $row['no_contractor']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['id_receipt_contractor']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['name_type_work']; ?></font></b></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['width_contractor']; ?><?php echo "&nbspเมตร" ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['hight_contractor']; ?><?php echo "&nbspเมตร" ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['contractor_number']; ?><?php echo "&nbspชุด" ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['total_contractor']; ?><?php echo "&nbspบาท" ?></b></font></center></td>
                          <td class="text-center"><font size=2><b><a href="contractor_detail_change.php?Action=Change&no_contractor=<?php echo $row['no_contractor']; ?>" onclick="return confirm('ยืนยันการเปลี่ยนสถานะ')">
                                <?php if($row ['status']=='0'){ 
                                ...
                                <td><center><a href="contractor_detail_edit.php?no_contractor=<?php echo $row['no_contractor']; ?>"><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                            class='fas fa-edit'></i> แก้ไข</button></a> 
                        <a href="data_delete.php?del_contractor_detail=<?php echo $row['no_contractor']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
                     ...
                     <?php endwhile ?>
                                        ...
                                        <center><a href="/project/employee/contractor.php" class="btn btn-success" type="button" style="width:13%">กลับ</a></center>
                                        <br>
    </div>
                                </div>

...
td {
  border: 0.5px solid;
    ...
    <table id="dataTable" class="table table-striped table-hover" >
            ...
            <?php
                    $sql = " SELECT sell.no_sell , sell.id_receipt_sell , product.name_product, sell.sell_number,sell.price_sell, sell.total_sell,sell.status
                    FROM sell 
                    INNER JOIN product  on sell.id_product  = product .id_product  Where id_receipt_sell='$id_receipt_sell'";
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                          ...
                          <td><center><font size=2 color="#000"><b><?php echo $row['sell_number']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['price_sell']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['total_sell']; ?></b></font></center></td>
                          <td class="text-center" ><font size=2><b><!-- <a href="sell_change.php?Action=Change&id_receipt_sell=<?php echo $row['id_receipt_sell']; ?>" onclick="return confirm('ยืนยันการเปลี่ยนสถานะ')"> -->
                                ...
                                <td><center><a href="sell_detail_edit.php?no_sell=<?php echo $row['no_sell']; ?>"><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                            class='fas fa-edit fa-lg'></i></button></a> 
                        <a href="data_delete.php?del_sell_detail=<?php echo $row['no_sell']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
                     ...
                     <?php endwhile ?>
                                        ...
                                        <center><a href="/project/employee/sell.php" class="btn btn-success" type="button" style="width:13%">กลับ</a></center>
                                        <br>
    </div>
                                </div>

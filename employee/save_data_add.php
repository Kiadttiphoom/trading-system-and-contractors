...
" . mysqli_error($objCon);
	 ...
	 mysqli_close($objCon);
		...
		{	 
			...
			$sql_product = "INSERT INTO product (id_product, name_product, id_type_product, price_sell, img_product)
			VALUES ('$id_product','$name_product','$id_type_product','$price_sell','$img_product')";

            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold "><font color="#000">เพิ่มข้อมูลบริษัท</font></h5></center>                           
                                </div>
                                <!-- Card Body -->
...
if (isset($_POST['insert_company'])) {
    ...
    $sql_company = $insertdata->insert($name_company, $tel_company, $provinces, $amphures,$districts, $zip_code, $address_company, $email_company ,$userid);
    if ($sql_company) {
        echo "<script>alert('เพิ่มข้อมูลข้อมูลบริษัทเรียบร้อย!');</script>";
        echo "<script>window.location.href='em_company.php'</script>";
    } else {
        echo "<script>alert('บางอย่างผิดพลาด กรุณาลองอีกครั้ง!');</script>";
        echo "<script>window.location.href='em_company_edit.php'</script>";
    }
}
...
$(function(){
    ...
    <?php
            ...
            <tr>
                <div class="mb-3 ">
                        <td style="width:5%"><label for="id_company" class="py-3"><font color="#000"><b>รหัสบริษัท</b></font></label></td>
                        <td style="width:5%"><input class="form-control text-center" name="id_company" value="<?php echo $id_company; ?>" type="text" id="id_company"  readonly aria-describedby="text" required style="width:100%"/></td>
                        <td style="width:5%"><label for="name_company" class="py-3"><font color="#000"><b>ชื่อบริษัท</b></font></label></td>
                        <td colspan="2"><input class="form-control text-center" name="name_company" type="text" id="name_company" class="form-control" placeholder="ชื่อบริษัท" aria-describedby="text" required style="width:100%"/></td>
                </div>
            </tr>
            
            <tr> 
                    <div class="mb-3">
                    <td style="width:5%"><label for="tel_company" class="py-3"><font color="#000"><b>เบอรโทรศัพท์</b></font></label></td>
                    <td style="width:10%"><input class="form-control text-center" type="text" name="tel_company" id="tel_company" placeholder="เบอร์โทรศัพท์"></td>
                    <td style="width:5%"><label for="address_company" class="py-3"><font color="#000"><b>อีเมล (ถ้ามี)</b></font></label></td>
                    <td colspan="2" style="width:10%"><input class="form-control text-center" type="email" name="email_company" id="email_company" placeholder="อีเมล"></td>
...
?>        
            ...
            <?php } ?>
                    ...
                    <td style="width:10%"><select value="-กรุณาเลือกจังหวัด-" class="form-control text-center" name="amphures" id="amphures" >
      </select></td>


                    <td style="width:5%"><label for="provinces" class="py-3"><font color="#000"><b>จังหวัด</b></font></label></td>
            ...
            <tr> 
                    <div class="mb-3">
                    <td style="width:5%"><label for="address_company" class="py-3"><font color="#000"><b>ที่อยู่</b></font></label></td>
                    <td colspan="3" style="width:10%"><textarea input class="form-control text-center" name="address_company" type="text" id="address_customer" class="form-control" placeholder="ที่อยู่" aria-describedby="text" required style="width:"></textarea></td>
                    ...
                    <br>
                    <center><button type="submit" name="save_company" class="btn btn-success">เพิ่มข้อมูลบริษัท</button>
                    <a href="company.php" type="submit" name="update" class="btn btn-danger">ยกเลิก</a></center>
                    <br>

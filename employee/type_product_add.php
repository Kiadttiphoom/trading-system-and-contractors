            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width:60%">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold "><font color="#000">เพิ่มข้อมูลประเภทสินค้า</font></h5></center>                          
                                </div>
                                <!-- Card Body -->
...
<div class="container">
    ...
    <?php
                                                    $sql= "Select Max(substr(id_type_product,-1))+1 as MaxID from type_product";
                                                    ...
                                                    if($new_id==''){
                                                        ...
                                                        $id_type_product="T".sprintf("%01d",$new_id);
                                                    }
                                                    ?>
            ...
            <!-- 2 column grid layout with text inputs for the first and last names -->
                <table style="width:70%" class="center text-center">
                        <tr>
                            ...
                            <td style="width:"><input value="<?php echo $id_type_product; ?>" name="id_type_product" type="text" id="id_type_product" class="form-control text-center" placeholder="รหัสประเภทสินค้า" required readonly style="width:100%"/></td>
                        </tr>
                        <tr >
                            <td><label class="form-label py-3" for="form1Example1"><font color="#000"><b>ชื่อประเภทสินค้า</b></font></label></td>
                            <td><input name="name_type_product" type="text" id="name_type_product" class="form-control text-center" placeholder="ชื่อประเภทสินค้า" required/></td>
                        </tr>
                        
                </table>   
        
                <br>
                    <center><button type="submit" name="save_type_product" class="btn btn-success">เพิ่มข้อมูล</button>

...
<div class="container-fluid">
        ...
        <div class="card shadow-lg mb-4">
            ...
            <div
                ...
                <h5 class="m-0 font-weight-bold "><font color="#000">ข้อมูลการส่งสินค้า</font></h5>
            ...
            <!-- Card Body -->
            <a href="/project/employee/sell_add.php" class="btn btn-success pull-right" type="button" style="width:%"><i class="fa fa-plus" aria-hidden="true"></i> เพิ่มข้อมูลการส่งสินค้า</a>
...
<tr  >
<th><center><font size=2 color=#FFFFFF>เลขที่ใบส่งของ</font></center></th>
...
<th><center><font size=2 color=#FFFFFF>สถานที่ส่ง</font></center></th>
<th><center><font size=2 color=#FFFFFF>วันที่สั่ง</font></center></th>
<th><center><font size=2 color=#FFFFFF>เวลาที่สั่ง</font></center></th>
...
?>    
  ...
  <tr>
     ...
     <!--  <td><center><a href='edit.php?id_product=<?php echo $row['id_product']; ?>&name_product=<?php echo $row['name_product']; ?>&id_type_product=<?php echo $row['id_type_product']; ?>&price_delivery=<?php echo $row['price_delivery']; ?>&price_delivery=<?php echo $row['price_delivery']; ?>'><button type='button' class='btn btn-success'>แก้ไข</button></a></center></td> -->

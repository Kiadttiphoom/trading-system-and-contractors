            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width:80%">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold "><font color="#000">เพิ่มข้อมูลสินค้า</font></h5></center>                           
                                </div>
                                <!-- Card Body -->
...
if (isset($_POST['insert_product'])) {
    ...
    $sql_product = $insertdata->insert_product($name_product, $id_type_product, $price_sell, $img_product ,$userid);
    if ($sql_product) {
...
<div class="container">
    ...
    <?php
                                                    $sql= "Select Max(substr(id_product,-3))+1 as MaxID from product";
                                                    ...
                                                    if($new_id==''){
                                                        ...
                                                        $id_product="A".sprintf("%03d",$new_id);
                                                    }
                                                    ?>
  ...
  margin-right: auto;
            ...
            <!-- 2 column grid layout with text inputs for the first and last names -->
                <table style="width:50%" class="center text-center">
                        <tr>
                            <td style="width:10%"><label class="form-label py-3" for="form1Example1"><font color="#000"><b>รหัสสินค้า</b></font></label></td>
                            <td style="width:20%"><input value="<?php echo $id_product; ?>" name="id_product" type="text" id="id_product" class="form-control text-center" placeholder="รหัสสินค้า" readonly required style="width:100%"/></td>
                        </tr>
                        <tr >
                            <td><label class="form-label py-3" for="form1Example1"><font color="#000"><b>ชื่อสินค้า</b></font></label></td>
                            <td><input name="name_product" type="text" id="name_product" class="form-control text-center" placeholder="ชื่อสินค้า" required/></td>
                        </tr>
                        <tr>
                        <td style="width:10%"><label  class="form-label py-3" for="form1Example1"><font color="#000"><b>ประเภทสินค้า</b></font></label></td>
                            <td><select class="form-control text-center" style="width:100%" id="id_type_product" name="id_type_product">
                                    <?php
                        ...
                        <tr >
                            <td><label class="form-label py-3" for="form1Example1"><font color="#000"><b>ราคา</b></font></label></td>
                            <td><input name="price_sell" type="text" id="price_sell" class="form-control text-center" placeholder="ราคา" required/></td>
                        </tr>
                        <tr >
                        ...
                        <tr >
                            ...
                            <td><input type="file" name="file" id="file" class="inputfile" /></td>
                        </tr>
                        
                </table>   
        
                <br>
                    <center><button type="submit" name="save_product" class="btn btn-success">เพิ่มข้อมูลสินค้า</button>

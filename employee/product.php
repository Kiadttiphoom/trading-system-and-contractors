                ...
                <div class="container-fluid">
                           <div class="card shadow-lg mb-4">
                               ...
                               <!-- Card Body -->
                                   ...
                                   <a href="product_add.php" class="btn btn-success pull-right" ><font color=#fff><i class="fa fa-plus" aria-hidden="true"></i> เพิ่มข้อมูลสินค้า</font></a>  
  ...
  border: 0.5px solid;
    ...
    <table id="dataTable" class="table table-striped table-hover" >
            ...
            <thead style="background-color:#f26b5f;">
                   ...
                   <th><center><font size=2 color=#FFFFFF>รูปสินค้า</font></center></th>
                   <th><center><font size=2 color=#FFFFFF>ชื่อสินค้า</font></center></th>
                   <th><center><font size=2 color=#FFFFFF>ประเภทสินค้า</font></center></th>
                   <th><center><font size=2 color=#FFFFFF>หน่วยนับ</font></center></th>
                   <th><center><font size=2 color=#FFFFFF>ราคาขาย</font></center></th>
           ...
           <?php
                    $sql = " SELECT product.id_product, product.name_product, product.price_sell, type_product.name_type_product, product.img_product, unit.name_unit
                    FROM product
                    INNER JOIN type_product ON product.id_type_product = type_product.id_type_product
                    INNER JOIN unit ON product.id_unit = unit.id_unit;";
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      ...
                      <tr >
                        <td class="text" align="center"><center><font size=2 color="#000"><b><?php echo $row['id_product']; ?></b></font></center></td>
                        <td style="width:10%"><center><img src="img/product/<?php echo $row["img_product"]; ?>" class="img" style="width:35%; height:35%;"/></center></td>
                          ...
                          <td><center><font size=2 color="#000"><b><?php echo $row['name_unit']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['price_sell']; ?></b></font></center></td>
                          <td><center><a href="product_edit.php?id_product=<?php echo $row['id_product']; ?>"><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                        class='fas fa-edit fa-lg'></i></button></a> 
                        <a href="data_delete.php?del_product=<?php echo $row['id_product']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"

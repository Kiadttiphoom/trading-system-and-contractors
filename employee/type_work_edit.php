            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width:60%">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold "><font color="#000">แก้ไขข้อมูลชนิดงาน</font></h5></center>                           
                                </div>
                                <!-- Card Body -->
...
if (isset($_POST['update_type_work'])) {

    $userid = $_GET['id_type_work'];
    $name_type_work = $_POST['name_type_work'];


    $sql_type_work = $updatedata->update_type_work($name_type_work, $userid);
    if ($sql_type_work) {
        echo "<script>alert('แก้ไขข้อมูลชนิดงานเรียบร้อย!');</script>";
        echo "<script>window.location.href='type_work.php'</script>";
    } else {
        echo "<script>alert('บางอย่างผิดพลาด กรุณาลองอีกครั้ง!');</script>";
        echo "<script>window.location.href='type_work_edit.php'</script>";
    }
}
...
?>       
    <?php 
        ...
        $sql_type_work = $updateuser->fetchonerecord_type_work($userid);
        while($row = mysqli_fetch_array($sql_type_work)) {
    ?>
    <style>
    table, th, td {
  ...
  margin-right: auto;
            ...
            <!-- 2 column grid layout with text inputs for the first and last names -->
                <table style="width:70%" class="center text-center">
                        <tr>
                            <td ><label class="form-label py-3" for="form1Example1"><font color="#000"><b>รหัสชนิดงาน</b></font></label></td>
                            <td style="width:"><input value="<?php echo $row['id_type_work']; ?>" name="id_type_work" type="text" id="id_type_work" class="form-control text-center" placeholder="รหัสประเภทสินค้า" readonly style="width:100%"/></td>
                        </tr>
                        <tr >
                            <td><label class="form-label py-3" for="form1Example1"><font color="#000"><b>ชื่อชนิดงาน</b></font></label></td>
                            <td><input value="<?php echo $row['name_type_work']; ?>" name="name_type_work" type="text" id="name_type_work" class="form-control text-center" placeholder="ชื่อประเภทสินค้า" required/></td>
                        </tr>
                        
                </table>   
				<?php } ?> 
                <br>
        <center><button type="submit" name="update_type_work" class="btn btn-success">แก้ไขข้อมูล</button>
        <a href="type_work.php" type="submit" name="update" class="btn btn-danger">ยกเลิก</a></center>
        <br>
    </form>
</div>

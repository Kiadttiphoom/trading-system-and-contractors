            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width:60%">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold "><font color="#000">เพิ่มข้อมูลหน่วยนับ</font></h5></center>                           
                                </div>
                                <!-- Card Body -->
            ...
            <!-- 2 column grid layout with text inputs for the first and last names -->
                <table style="width:70%" class="center text-center">
                        <tr>
                            ...
                            <td style="width:"><input value="<?php echo $id_unit; ?>" name="id_unit" type="text" id="id_unit" class="form-control text-center" placeholder="รหัสหน่อยนับ" readonly style="width:100%"/></td>
                        </tr>
                        <tr >
                            <td><label class="form-label py-3" for="form1Example1"><font color="#000"><b>ชื่อหน่วยนับ</b></font></label></td>
                            <td><input name="name_unit" type="text" id="name_unit" class="form-control text-center" placeholder="ชื่อหน่วยนับ" required/></td>
                        </tr>
                        
                </table>   
        
                <br>
                    <center><button type="submit" name="save_unit" class="btn btn-success">เพิ่มข้อมูล</button>

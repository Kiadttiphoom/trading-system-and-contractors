                ...
                <div class="container-fluid">
                            <div class="card shadow-lg mb-4">
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold "><font color="#000">ข้อมูลลูกค้า</h5>
...
$sql = " SELECT customer.id_customer, customer.prefix_name, customer.name_customer, customer.tel_customer, customer.address_customer,
customer.id_provinces, customer.id_districts, customer.id_amphures, customer.zip_code, customer.email_customer,
...
<a href="customer_add.php" class="btn btn-success pull-right" ><font color=#fff><i class="fa fa-plus" aria-hidden="true"></i> เพิ่มข้อมูลลูกค้า</font></a>  
  ...
  border: 0.5px solid;
    ...
    <table id="dataTable" class="table table-striped table-hover " >
        ...
        <thead style="background-color:#f26b5f;">
            <th class="text-center"><font size=2 color=#fff>รหัสลูกค้า</font></th>
            <th class="text-center"><font size=2 color=#fff>ชื่อลูกค้า</font></th>
        ...
        <?php while($row = $result->fetch_assoc()): ?> 
                <tr>
                    ...
                    <td class="text-center"><font size=2 color=#000><b><?php echo $row['id_customer']; ?></b></font></td>
                    <td class="text-center"><font size=2 color=#000><b><?php echo $row['prefix_name']; ?> <?php echo $row['name_customer']; ?></b></font></td>
    
                    <td class="text-center"><font size=2 color=#000><b><?php echo $row['tel_customer']; ?></b></font></td>
                    <td class="text-center"><font size=2 color=#000><b><?php echo $row['address_customer']; ?> 
                    <?php echo $row['name_districts']; ?> 
                    <?php echo $row['name_amphures']; ?> 
                    <?php echo $row['name_provinces']; ?>
                    <?php echo $row['zip_code']; ?></font></td>
                    <td class="text-center"><font size=2 color=#000><b><?php echo $row['email_customer']; ?></b></font></td>


                    
                    
                    <td><center><a href="customer_edit.php?id_customer=<?php echo $row['id_customer']; ?>"><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                            class='fas fa-edit fa-lg'></i></button></a> 
                    <a href="data_delete.php?del_customer=<?php echo $row['id_customer']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"

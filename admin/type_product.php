                ...
                <div class="container-fluid">
                            <div class="card shadow-lg mb-4">
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold "><font color="#000">ข้อมูลประเภทสินค้า</h5>
                                
                                </div>
                                <!-- Card Body -->
                                    <div class="container col-lg-12 py-2 " >

                                    <a href="type_product_add.php" class="btn btn-success pull-right" ><font color=#fff><i class="fa fa-plus" aria-hidden="true"></i> เพิ่มข้อมูลประเภทสินค้า</font></a> 
...
td {
  border: 0.5px solid;
    ...
    <table id="dataTable" class="table table-striped table-hover" >
            ...
            <thead style="background-color:#f26b5f;">
                    <th><center><font size=2 color=#FFFFFF><b>รหัสประเภทสินค้า</b></font></center></th>
                    <th><center><font size=2 color=#FFFFFF><b>ชื่อประเภทสินค้า</b></font></center></th>
            ...
            ?>   
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                        <td><center><font size=2 color="#000"><b><?php echo $row['id_type_product']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['name_type_product']; ?></b></font></center></td>
                          <td><center><a href="type_product_edit.php?id_type_product=<?php echo $row['id_type_product']; ?>"><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                        class='fas fa-edit fa-lg'></i></button></a>
                        <a href="data_delete.php?del_type_product=<?php echo $row['id_type_product']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form name="addtypeproduct" method="post" action="type_product_save.php" style="width: 100%; margin: 0 auto;" class="text-center mt-5">
        <div class="card">
                <br>
        <div class="container">
        <br>

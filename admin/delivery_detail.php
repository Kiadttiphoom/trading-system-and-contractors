  ...
  border: 0.5px solid;
    ...
    <table id="dataTable" class="table table-striped table-hover" >
            ...
            <?php
                    ...
                    Where id_receipt_delivery='$id_receipt_delivery'";
                    $result = $objCon->query($sql);   
                    while($row = $result->fetch_assoc()):
                        $delivery_number = $row['delivery_number'];
                        $price_delivery = $row['price_delivery'];
                        $total_delivery = $delivery_number*$price_delivery;
            ?> 
                      ...
                      <tr>
                          ...
                          <td><center><font size=2 color="#000"><b><?php echo $total_delivery ?></b><?php echo "&nbspบาท" ?></font></center></td>
                     ...
                     <?php endwhile ?>
                                        ...
                                        <center><a href="/project/admin/delivery.php" class="btn btn-warning" type="button" style="width:13%">กลับ</a></center>
                                        <br>
    </div>
                                </div>

...
<body id="page-top">
   ...
   <hr class="sidebar-divider">
    ...
    ?>   
            ...
            <thead >
                <tr class="bg-primary " >
                    <th><center><font size=2 color=#FFFFFF>รหัสพนักงาน</font></center></th>
            ...
            ?>   
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                        <td><center><font size=2><?php echo $row['username']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['name_employee']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['tel_employee']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['address_employee']; ?></font></center></td>
                          <td><center><font size=2><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                            class='fas fa-edit'></i> แก้ไข</button></font>
                        <font size=2><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
                 ...
                 <center><button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"> เพิ่มข้อมูลพนักงาน</button></center>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form name="addemployee" method="post" action="save_employee.php" style="width: 100%; margin: 0 auto;" class="text-center mt-5">
        <div class="card">
                <br>
        <div class="container">
            <img src="img/avatar1.png" width="25%" height="45%" alt="alternative">
        <br>
        <h2>เพิ่มข้อมูลพนักงาน</h2><br>
        
            <!-- 2 column grid layout with text inputs for the first and last names -->
            
                    
                <input name="txtusername" type="text" id="txtusername" class="form-control" placeholder="รหัสพนักงาน" required/><br>
                ...
                <textarea name="txtaddress_employee" type="text" id="txtaddress_employee" class="form-control" placeholder="ที่อยู่" required></textarea><br>
            ...
            <select class="form-control text-center" name="ddlstatus_employee" id="ddlstatus_employee" >
            ...
            <br><br>
            <button type="submit" name="submit" value="Save" class="btn btn-success btn-block mb-4">เพิ่มข้อมูลพนักงาน</button>
            <a class="btn btn-primary btn-block mb-4" href="employee.php">กลับ</a>
            </div>
            </div>
     </form>
      <div>

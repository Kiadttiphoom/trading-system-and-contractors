...
<body id="page-top">
    ...
    <div id="wrapper">
       ...
       <!--    <li class="nav-item">
           ...
           <!--  <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/project/admin/system/delivery/delivery.php">
                    <i class="fas fa-fw fa-table"></i>
   ...
   <hr class="sidebar-divider">
                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">ข้อมูลการส่งสินค้า</h6>
    ...
    ?>   
            ...
            <thead >
                <tr class="bg-primary " >
                    <th><center><font size=2 color=#FFFFFF>เลขที่ใบส่งสินค้า</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>รหัสพนักงาน</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>จำนวนส่ง</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>ราคาส่ง</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>จำนวนรวมส่ง</font></center></th>
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                          ...
                          <td><center><font size=2 ><?php echo $row['id_delivery']; ?></font></center></td>
                          <td><center><font size=2 ><?php echo $row['id_employee']; ?></font></center></td>
                          <td><center><font size=2 ><?php echo $row['impart_buy']; ?></font></center></td>
                          <td><center><font size=2 ><?php echo $row['price_number_imprat']; ?></font></center></td>
                          <td><center><font size=2 ><?php echo $row['total_impart']; ?></font></center></td>
                          <td><center><font size=2 ><?php echo $row['status']; ?></font></center></td>
                          
                          <td><center>
                            
                          <!-- <a href="detail_buy.php"><button type="button" class="btn btn-success btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#"><i
                                                                         class='fa fa-info-circle '></i> รายละเอียด</button></a> -->

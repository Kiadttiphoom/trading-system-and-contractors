                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">การอนุมัติการส่งสินค้า</h6>
    ...
    ?>   
            ...
            <thead >
                <tr class="bg-primary " >
                    ...
                    <th><center><font size=2 color=#FFFFFF>วัน/เดือน/ปี</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>ตรวจสอบข้อมูล</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>อนุุมัติการส่งสินค้า</font></center></th>
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                          ...
                          <td><center><font size=2><button type="button" class="btn btn-success btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#"><i
                                                                         class='fa fa-info-circle '></i> ตรวจสอบข้อมูล</button></font></center></td>

...
<?php
  ...
  $id_employee = $_POST["id_employee"];
    echo $date_receipt_sell;
    echo "<br>";
   echo $time_receipt_sell;
   echo "<br>";
   echo $id_receipt_sell;
   echo "<br>";
   echo $id_customer;
   echo "<br>";
   echo $id_employee;
       ...
       $sql1 = "INSERT INTO receipt_sell (id_receipt_sell, date_receipt_sell, time_receipt_sell, id_employee , id_customer) 
      VALUES ('$id_receipt_sell','$date_receipt_sell','$time_receipt_sell','$id_employee','$id_customer')";

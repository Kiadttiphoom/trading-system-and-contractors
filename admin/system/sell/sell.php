    ...
    ?>   
            ...
            <thead >
                <tr class="bg-primary " >
                    ...
                    <th><center><font size=2 color=#FFFFFF>รายละเอียด</font></center></th>
                </thead>
            <tbody>
            <?php
                    $sql = " SELECT * FROM receipt_sell ";
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                          ...
                          <td><center><font size=2><?php echo $row['id_employee']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['id_customer']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['date_receipt_sell']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['time_receipt_sell']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['status']; ?></font></center></td>
                          
                          <td><center><a href="detail_sell.php"><button type="button" class="btn btn-success btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#"><i
                                                                         class='fa fa-info-circle '></i> รายละเอียด</button></a></center></td>

<?php 
    ...
    class DB_con {
        ...
        public function update_employee($username,  $prefix_name, $name_employee, $tel_employee, $provinces, $amphures, $districts, $zip_code, $address_employee, $email_employee, $userid) {

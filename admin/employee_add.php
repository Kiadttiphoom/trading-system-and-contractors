            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold"><font color="#000">เพิ่มข้อมูลพนักงาน</font></h5></center>                           
                                </div>
                                <!-- Card Body -->
    ...
    <?php
            ...
            <tr>
                <div class="mb-3 ">
                    ...
                    ?>
                        <td style="width:6%"><label for="username" class="py-3"><font color="#000"><b>รหัสพนักงาน</label></td>
                        <td style="width:12%"><input class="form-control text-center" name="username" value="<?php echo $username; ?>" type="text" id="username" placeholder="รหัสพนักงาน" aria-describedby="text" readonly required style="width:100%"/></td>
                        <td style="width:5%"><label for="status_employee" class="py-3"><font color="#000"><b>สถานะ</label></td>
            ...
            <tr>        
                    <div class="mb-3">
                    <td style="width:5%"><label for="password" class="py-3"><font color="#000"><b>รหัสผ่าน</b></font></label></td>
                    <td style="width:5%"><input class="form-control text-center" name="password" type="password" value="123456" id="password" class="form-control" placeholder="รหัสผ่าน" aria-describedby="text" readonly required style="width:100%"/></td>
                    <td style="width:6%"><label for="conpassword" class="py-3"><font color="#000"><b>รหัสผ่านอีกครั้ง</label></td>
                    <td colspan="2" style="width:8%"><input class="form-control text-center" name="conpassword" type="password" value="123456" id="conpassword" class="form-control" placeholder="รหัสผ่านอีกครั้ง" aria-describedby="text" readonly required style="width:100%"/></td>
                    </div>
            </tr>
            <tr>        
                    <div class="mb-3">
                    ...
                    <td colspan="2" style="width:8%"><input class="form-control text-center" name="name_employee" type="text" id="name_employee" class="form-control" placeholder="ชื่อ-นามสกุล" aria-describedby="text" required style="width:100%"/></td>
                    </div>
            </tr>
            <tr> 
                    <div class="mb-3">
                    <td style="width:5%"><label for="tel_employee" class="py-3"><font color="#000"><b>เบอรโทรศัพท์</b></font></label></td>
                    <td style="width:8%"><input class="form-control text-center" type="tel" name="tel_employee" id="tel_employee" placeholder="เบอร์โทรศัพท์"></td>
                    <td style="width:5%"><label for="email_employee" class="py-3"><font color="#000"><b>อีเมล (ถ้ามี)</b></font></label></td>
                    <td colspan="2" style="width:10%"><input class="form-control text-center" type="email" name="email_employee" id="email_employee" placeholder="อีเมล"></td>
                </div>
            </tr>
            <tr> 
            <?php
...
?>        
            ...
            <?php } ?>
                    ...
                    <td style="width:4%"><label for="provinces" class="py-3"><font color="#000"><b>ตำบล</b></font></label></td>
            ...
            <tr> 
                    ...
                    <td colspan="3" style="width:10%"><textarea input class="form-control text-center" name="address_employee" type="text" id="address_employee" class="form-control" placeholder="ที่อยู่" aria-describedby="text" required style="width:"></textarea></td>
            ...
            <tr> 
                    ...
                    <br>
                    <center><button type="submit" name="save_employee" class="btn btn-success">เพิ่มข้อมูลพนักงาน</button>
                    <a href="employee.php" type="submit" name="update" class="btn btn-danger">ยกเลิก</a></center>
                    <br>

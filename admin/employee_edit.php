            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold "><font color="#000">แก้ไขข้อมูลพนักงาน</font></h5></center>                           
                                </div>
                                <!-- Card Body -->
...
if (isset($_POST['update_employee'])) {
    ...
    $sql_employee = $updatedata->update_employee($username,  $prefix_name, $name_employee, $tel_employee, $provinces, $amphures,$districts, $zip_code, $address_employee, $email_employee, $userid);
    if ($sql_employee) {
...
<tr>
                <div class="mb-3 ">
                        ...
                        <td style="width:12%"><input value="<?php echo $row['username']; ?>" class="form-control text-center" name="username" value="" type="text" id="username" placeholder="รหัสพนักงาน" aria-describedby="text" readonly required style="width:100%"/></td>
                        <td style="width:6%"><label for="status_employee" class="py-3"><font color="#000"><b>สถานะ</b></font></label></td>
                        <td style="width:10%"><input value="<?php echo $row['status_employee']; ?>" class="form-control text-center" name="stastus_employee" value="" type="text" id="stastus_employee" placeholder="สถานะ" aria-describedby="text" readonly required style="width:100%"/></td>
...
<td style="width:8%"><select name="prefix_name" id="prefix_name" value="<?php echo $row['prefix_name']; ?>" class="form-control text-center" required style="width:100%">
...
<td colspan="2" style="width:10%"><input required value="<?php echo $row['name_employee']; ?>" class="form-control text-center" name="name_employee" type="text" id="name_employee" class="form-control" placeholder="ชื่อ - นามสกุล" aria-describedby="text" required style="width:100%"/></td>
</div>
</tr>
<tr> 
<div class="mb-3">
<td style="width:5%"><label for="tel_employee" class="py-3"><font color="#000"><b>เบอรโทรศัพท์</b></font></label></td>
<td style="width:10%"><input value="<?php echo $row['tel_employee']; ?>" class="form-control text-center" type="text" name="tel_employee" id="tel_employee" placeholder="เบอร์โทรศัพท์" required></td>
<td style="width:5%"><label for="zip_code" class="py-3"><font color="#000"><b>อีเมล</b></font></label></td>
                <td colspan="2" style="width:10%"><input value="<?php echo $row['email_employee']; ?>" class="form-control text-center" type="email" name="email_employee" id="email_employee" ></td>
                </div>
</div>
</tr>
                <tr> 
                ...
                <td style="width:3%"><label for="provinces" class="py-3"><font color="#000"><b>ตำบล</b></label></td>
                ...
                <td style="width:10%"><input value="" class="form-control text-center" type="text" name="zip_code" id="zip_code" ></td>
                </div>
                </tr>
<tr> 
<div class="mb-3">
<td style="width:5%"><label for="address_employee" class="py-3"><font color="#000"><b>ที่อยู่</b></font></label></td>
<td colspan="3" style="width:10%"><textarea value="" input class="form-control text-center" name="address_employee" type="text" id="address_employee" class="form-control" placeholder="ที่อยู่" aria-describedby="text" required style="width:"><?php echo $row['address_employee']; ?></textarea></td>
...
<?php include('script.php');?> 
        ...
        <br>
        <center>
        <button type="submit" name="update_employee" class="btn btn-success">แก้ไขข้อมูลพนักงาน</button>

            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width:60%">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold text-primary"><font color="#000"><b>เพิ่มข้อมูลชนิดงาน</b></font></h5></center>                           
                                </div>
                                <!-- Card Body -->
...
if (isset($_POST['insert_type_work'])) {

    $userid = $_GET['id_type_work'];
	$name_type_work = $_POST['name_type_work'];


    $sql_type_work = $insertdata->insert_type_work($name_type_work ,$userid);
    if ($sql_type_work) {
        echo "<script>alert('เพิ่มข้อมูลข้อมูลบริษัทเรียบร้อย!');</script>";
        echo "<script>window.location.href='type_work_add.php'</script>";
    } else {
...
?>  
  ...
  margin-right: auto;
                            ...
                            <?php
                                                    $sql= "Select Max(substr(id_type_work,-1))+1 as MaxID from type_work";
                                                    ...
                                                    if($new_id==''){
                                                        ...
                                                        $id_type_work="w".sprintf("%01d",$new_id);
                                                    }
                                ?>
            <!-- 2 column grid layout with text inputs for the first and last names -->
                <table style="width:70%" class="center text-center">
                        <tr>
                            ...
                            <td style="width:"><input value="<?php echo $id_type_work; ?>" name="id_type_work" type="text" id="id_type_work" class="form-control text-center" placeholder="รหัสชนิดงาน" readonly style="width:100%"/></td>
                        </tr>
                        <tr >
                            <td><label class="form-label py-3" for="form1Example1"><font color="#000"><b>ชื่อชนิดงาน</b></font></label></td>
                            <td><input name="name_type_work" type="text" id="name_type_work" class="form-control text-center" placeholder="ชื่อชนิดงาน" required/></td>
                        </tr>
                        
                </table>   
        
                <br>
                    <center><button type="submit" name="save_type_work" class="btn btn-success">เพิ่มข้อมูล</button>

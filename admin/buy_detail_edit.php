...
if (isset($_POST['update_buy_detail'])) {
    ...
    $sql_buy_detail = $updatedata->update_buy_detail($id_product, $buy_number, $price_buy , $total_buy ,$userid);
    if ($sql_buy_detail) {
...
?>       
    <?php 
        ...
        $sql_buy_detail = $updateuser->fetchonerecord_buy_detail($userid);
        while($row = mysqli_fetch_array($sql_buy_detail)) {
    ?>
    <style>
    table, th, td {
  ...
  margin-right: auto;
   ...
   <?php
            ...
            ?>
   <?php
                    $sql = " SELECT buy.no_buy, product.name_product, buy.buy_number,buy.price_buy, buy.total_buy
                    FROM buy 
                    INNER JOIN product  on buy.id_product  = product .id_product Where no_buy='$no_buy'";
            ...
            <tr>
                <div class="mb-3 ">
                        <td style="width:10%"><label for="id_receipt_buy" class="py-3"><font color="#000"><b>เลขที่ใบเสร็จซื้อ</b></font></label></td>
                        <td style="width:20%"><input class="form-control text-center" name="id_receipt_buy" value="<?php echo $row['id_receipt_buy']; ?>" type="text" id="id_receipt_buy"  readonly aria-describedby="text" required style="width:100%"/></td>
            ...
            <tr>        
                    <div class="mb-3">
                    <td style="width:5%"><label for="buy_number" class="py-3"><font color="#000"><b>จำนวน</b></font></label></td>
                    <td style="width:5%"><input onfocus="sum()"  onblur="sum()" onchange="sum()" onkeyup="sum()" class="form-control text-center" id="buy_number" name="buy_number" value="<?php echo $row['buy_number']; ?>" type="text" aria-describedby="text" required style="width:100%"/></td></td>
                    </div>
            </tr>
            <tr>        
                    <div class="mb-3">
                    <td style="width:5%"><label for="price_buy" class="py-3"><font color="#000"><b>ราคา</b></font></label></td>
                    <td style="width:5%"><input onfocus="sum()"  onblur="sum()" onchange="sum()" onkeyup="sum()" class="form-control text-center" id="price_buy" name="price_buy" value="<?php echo $row['price_buy']; ?>" type="text" aria-describedby="text" required style="width:100%"/></td></td>
                    </div>
            </tr>
            <tr>        
                    <div class="mb-3">
                    <td style="width:5%"><label for="total_buy" class="py-3"><font color="#000"><b>ราคารวม</b></font></label></td>
                    <td style="width:5%"><input readonly onfocus="sum()"  onblur="sum()" onchange="sum()" onkeyup="sum()" class="form-control text-center" id="total_buy" name="total_buy" value="<?php echo $row['total_buy']; ?>" type="text" aria-describedby="text" required style="width:100%"/></td></td>
                    </div>
            </tr>
            <script language="javascript">
var obj= document.all;
function sum(){
	obj.total_buy.value=parseInt(obj.buy_number.value)*parseInt(obj.price_buy.value);
}
</script>
            <?php  }   ?>
        </table>  </center>  
		...
		<br>
        <center><button type="submit" name="update_buy_detail" class="btn btn-success">แก้ไขข้อมูลซื้อ</button>

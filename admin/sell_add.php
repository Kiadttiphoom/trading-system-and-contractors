...
<li class="nav-item active">
    <a class="nav-link" href="/project/admin/index_admin.php">
        ...
        <span><font size="">หน้าหลัก</font></span></a>
</li>
            ...
            <div
                ...
                <center><h5 class="m-0 font-weight-bold "><font color="#000">เพิ่มข้อมูลการขาย</font></h5></center>                           
                    ...
                    <center><table border="0" style="width:90%"> 
                                        ...
                                        <tr>
                                            <td width="20%"><h6 align="center" class="py-3 text-right"><b><font color="#000">สินค้า&nbsp;&nbsp;</font></b></h6></td>
                            ...
                            <div class="col-md-5">
                                ...
                                <form method="post" style="width:60%; height:10%;" action="sell_add.php?action=add&id_product=<?php echo $row["id_product"]; ?>">
                                    <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
                                        ...
                                        <h6 class="text-info"><b><font color="#000"><?php echo $row["name_product"]; ?><font color="#000"></b></h6>

                                        <h6 class="text-danger"><font color="#000">ราคา:</font> <b><?php echo $row["price_sell"]; ?></b><font color="#000"> บาท</font></h6>
                                        <h6 class="text-danger"><font color="#000">สินค้าคงเหลือ:</font><b> <?php echo $stock; ?></b></h6>

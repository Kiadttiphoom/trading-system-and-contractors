...
if (isset($_POST['update_product'])) {
    ...
    $sql_product = $updatedata->update_product($name_product, $id_type_product, $price_sell ,$userid);
    if ($sql_product) {
...
?>       
  ...
  margin-right: auto;
   ...
   <center> <table style="width:50%" class="center text-center"> 
		...
		<br>
        <center><button type="submit" name="update_product" class="btn btn-success">แก้ไขข้อมูลสินค้า</button>

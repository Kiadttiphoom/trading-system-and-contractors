            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow-lg mb-4">
                                ...
                                <a href="/project/admin/sell_add.php" class="btn btn-success pull-right" type="button" style="width:%"><i class="fa fa-plus" aria-hidden="true"></i> เพิ่มข้อมูลขายสินค้า</a>
                <!-- Fixed header table-->

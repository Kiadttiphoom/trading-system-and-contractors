                ...
                <div class="container-fluid">
                            <div class="card shadow-lg mb-4">
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary"><font color="#000">ข้อมูลหน่วยนับ</font></h5>
                                
                                </div>
                                <!-- Card Body -->
                                    <div class="container col-lg-12 py-2 " >
                                    <a href="unit_add.php" class="btn btn-success pull-right" ><font color=#fff><i class="fa fa-plus" aria-hidden="true"></i> เพิ่มข้อมูลหน่วยนับ</font></a> 
  ...
  border: 0.5px solid;
    ...
    <table id="dataTable" class="table table-striped table-hover" >
            ...
            <thead style="background-color:#f26b5f;">
                    <th><center><font size=2 color=#FFFFFF><b>รหัสหน่วยนับ</b></font></center></th>
                    <th><center><font size=2 color=#FFFFFF><b>ชื่อหน่วยนับ</b></font></center></th>
            ...
            ?>   
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                        <td><center><font size=2 color="#000"><b><?php echo $row['id_unit']; ?></b></font></center></td>
                          <td><center><font size=2 color="#000"><b><?php echo $row['name_unit']; ?></b></font></center></td>
                          <td><center><a href="unit_edit.php?id_unit=<?php echo $row['id_unit']; ?>"><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                        class='fas fa-edit fa-lg'></i></button></a> 
                        <a href="data_delete.php?del_unit=<?php echo $row['id_unit']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"

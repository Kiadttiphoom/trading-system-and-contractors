                ...
                <div class="container-fluid">
                            <div class="card shadow-lg mb-4">
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold "><font color="#000">ข้อมูลพนักงาน</font></h5>
...
$sql = " SELECT employee.id_employee, employee.username, employee.password, employee.prefix_name, employee.name_employee, employee.tel_employee, employee.address_employee,
employee.id_provinces, employee.id_districts, employee.id_amphures, employee.zip_code, employee.email_employee, employee.status_employee,
provinces.name_provinces, districts.name_districts, amphures.name_amphures
FROM employee
INNER JOIN provinces ON employee.id_provinces = provinces.id_provinces
INNER JOIN districts ON employee.id_districts = districts.id_districts
INNER JOIN amphures ON employee.id_amphures = amphures.id_amphures";
...
<a href="employee_add.php" class="btn btn-success pull-right" ><font color=#fff><i class="fa fa-plus" aria-hidden="true"></i> เพิ่มข้อมูลพนักงาน</font></a>  
...
td {
  border: 0.5px solid;
    ...
    <thead style="background-color:#f26b5f;">
            <th class="text-center"><font size=2 color=#fff>Username</font></th>
            <!-- <th class="text-center"><font size=2 color=#fff>Password</font></th> -->
            <th class="text-center"><font size=2 color=#fff>ชื่อพนักงาน</font></font></th>
            <th class="text-center"><font size=2 color=#fff>เบอรโทรศัพท์</font></th>
            <th class="text-center"><font size=2 color=#fff>ที่อยู่</font></th>
            <th class="text-center"><font size=2 color=#fff>อีเมล</font></th>
            <th class="text-center"><font size=2 color=#fff>สถานะ</font></th>
            <th class="text-center"><font size=2 color=#fff><i class="fas fa-align-justify"></font></th>
        </thead>
        ...
        <?php while($row = $result->fetch_assoc()): ?> 
                <tr>
                    ...
                    <td class="text-center"><font size=2 color="#000"><b><?php echo $row['username']; ?></b></font></td>
                    <!-- <td class="text-center"><font size=2><?php echo $row['password']; ?></font></td> -->
                    <td class="text-center"><font size=2 color="#000"><b><?php echo $row['prefix_name']; ?> <?php echo $row['name_employee']; ?></b></font></td>
                    <td class="text-center"><font size=2 color="#000"><b><?php echo $row['tel_employee']; ?></b></font></td>
                    <td class="text-center"><font size=2 color="#000"><b><?php echo $row['address_employee']; ?> 
                    <?php echo $row['name_districts']; ?> 
                    <?php echo $row['name_amphures']; ?> 
                    <?php echo $row['name_provinces']; ?>
                    <?php echo $row['zip_code']; ?></font></b></td>
                    <td class="text-center"><font size=2 color="#000"><b><?php echo $row['email_employee']; ?></b></font></td>
                    <td class="text-center"><font size=2 color="#000"><b><?php echo $row['status_employee']; ?></b></font></td>
                    ...
                    <a href="password_reset.php?id_employee=<?php echo $row['id_employee']; ?>"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="resetpassword">
                    <i  class='fas fa-redo '></i></button></a>
                    <a href="employee_edit.php?id_employee=<?php echo $row['id_employee']; ?>"><button type="button" class="btn btn-warning btn-sm"
                    ...
                    <a href="data_delete.php?del_employee=<?php echo $row['id_employee']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"

            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width:60%">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold "><font color="#000">แก้ไขข้อมูลหน่วยนับ</font></h5></center>                           
                                </div>
                                <!-- Card Body -->
...
if (isset($_POST['update_unit'])) {
    ...
    $sql_unit = $updatedata->update_unit($name_unit, $userid);
    if ($sql_unit) {
        echo "<script>alert('แก้ไขข้อมูลหน่วยนับเรียบร้อย!');</script>";
        echo "<script>window.location.href='unit.php'</script>";
    } else {
        echo "<script>alert('บางอย่างผิดพลาด กรุณาลองอีกครั้ง!');</script>";
        echo "<script>window.location.href='unit_edit.php'</script>";
    }
}
...
?>       
    <?php 
        ...
        $sql_unit = $updateuser->fetchonerecord_unit($userid);
        while($row = mysqli_fetch_array($sql_unit)) {
    ?>
    <style>
    table, th, td {
  ...
  margin-right: auto;
            ...
            <!-- 2 column grid layout with text inputs for the first and last names -->
                <table style="width:70%" class="center text-center">
                        <tr>
                            <td ><label class="form-label py-3" for="form1Example1"><font color="#000"><b>รหัสหน่วยนับ</b></font></label></td>
                            <td style="width:"><input value="<?php echo $row['id_unit']; ?>" name="id_unit" type="text" id="id_unit" class="form-control text-center" placeholder="รหัสประเภทสินค้า" readonly style="width:100%"/></td>
                        </tr>
                        <tr >
                            <td><label class="form-label py-3" for="form1Example1"><font color="#000"><b>ชื่อหน่วยนับ</b></font></label></td>
                            <td><input value="<?php echo $row['name_unit']; ?>" name="name_unit" type="text" id="name_unit" class="form-control text-center" placeholder="ชื่อประเภทสินค้า" required/></td>
                        </tr>
                        
                </table>   
				<?php } ?> 
                <br>
        <center><button type="submit" name="update_unit" class="btn btn-success">แก้ไขข้อมูล</button>
        <a href="unit.php" type="submit" name="update" class="btn btn-danger">ยกเลิก</a></center>
        <br>
    </form>
</div>

                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="/project/login/login.php" data-toggle="modal" data-target="#logoutModal">
    ...
    ?>   
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                          <td><center><font size=2><?php echo $row['id_company']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['name_company']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['tel_company']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['address_company']; ?></font></center></td>
                          <td><center><font size=2><a href='edit_company.php?id_company=<?php echo $row['id_company']; ?>&name_company=<?php echo $row['name_company']; ?>&tel_company=<?php echo $row['tel_company']; ?>&address_company=<?php echo $row['address_company']; ?>'><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                            class='fas fa-edit'></i> แก้ไข</button></a></font>
                        <font size=2><a href='delete_company.php?id_company=<?php echo $row['id_company']; ?>'><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
...
<form name="addcompany" method="post" action="save_company.php" style="width: 100%; margin: 0 auto;" class="text-center mt-5">
            ...
            <!-- 2 column grid layout with text inputs for the first and last names -->
             <div class="form-group">
                 <div><center><input class="form-control text-center" value="<?php echo $id_company; ?>" name="id_company" type="text" id="id_company" class="form-control" readonly aria-describedby="text" required style="width:50%"/></center>
                </div>
            </div>
            
            
            <div class="form-group">
                <div><center><input class="form-control text-center" name="name_company" type="text" id="name_company" class="form-control" placeholder="ชื่อบริษัท" aria-describedby="text" required style="width:50%"/></center>
                </div>
            </div>
            
            
            <div class="form-group">
                <div><center><input class="form-control text-center" name="tel_company" type="text" id="tel_company" class="form-control" placeholder="เบอร์โทรศัพท์" aria-describedby="text" required style="width:50%"/></center>
                </div>
            </div>
            
            <div class="form-group">
                <div><center><textarea input class="form-control text-center" name="address_company" type="text" id="address_company" class="form-control" placeholder="ที่อยู่" aria-describedby="text" required style="width:80%"></textarea></center>
                </div>
            </div>

            <div class="d-grid gap-2 d-md-block">
                <button type="submit" name="submit" value="Save" class="btn btn-primary" style="width:">เพิ่มข้อมูล</button>
                <a class="btn btn-danger" href="company.php" style="width:">ยกเลิก</a>
            </div>
                                <br> 
            </div>

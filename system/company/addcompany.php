...
<form name="addcompany" method="post" action="save_company.php" style="width: 50%; margin: 0 auto;" class="text-center mt-5">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php
                                                    ...
                                                    if($new_id==''){
                                                        ...
                                                        $id_company="c".sprintf("%02d",$new_id);
                                                    }
                                                    ?>
        
            <!-- 2 column grid layout with text inputs for the first and last names -->
             <div class="form-group">
                <div class="col-sm-12"><input class="form-control text-center" value="<?php echo $id_company; ?>" name="id_company" type="text" id="id_company" class="form-control" readonly aria-describedby="text" required/>
                </div>
            </div>
            
            
            <div class="form-group">
                <div class="col-sm-12"><input class="form-control text-center" name="name_company" type="text" id="name_company" class="form-control" placeholder="ชื่อบริษัท" aria-describedby="text" required/>
                </div>
            </div>
            
            
            <div class="form-group">
                <div class="col-sm-12"><input class="form-control text-center" name="tel_company" type="text" id="tel_company" class="form-control" placeholder="เบอร์โทรศัพท์" aria-describedby="text" required/>
                </div>
            </div>
            
            <div class="form-group">
                <div class="col-sm-12"><textarea input class="form-control text-center" name="address_company" type="text" id="address_company" class="form-control" placeholder="ที่อยู่" aria-describedby="text" required></textarea>
                </div>
            </div>

    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">รายงานการซื้อสินค้า</h5>
                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                           ...
                           $result = $objCon->query($sql);?>
                            ...
                            <tr>
                                <td name="a[]">
                                    <center><font size="2" color="#000"><b><?php echo $row['id_receipt_buy']; ?></b></font></center>
                                </td>
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['date_receipt_buy']."  ".$row['time_receipt_buy']; ?></b></font></center>
                                </td>
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['name_company']; ?></b></font></center>
                                </td>
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['name_product']; ?></b></font></center>
                                </td>
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['buy_number']; ?></b></font></center>
                                </td>
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['price_buy']; ?></b></font></center>
                                </td>
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['total_buy']; ?></b></font></center>
                                </td>
                               
                            </tr>
                            
                            <?php @$amount_total += $row['total_buy']; ?>
                            <?php endwhile ?>
                            <tr>
...
<?php
            ...
            $query = "SELECT Sum(buy.total_buy) AS total_buy, DATE_FORMAT(date_receipt_buy, '%d-%M-%Y') AS datesave
            FROM receipt_buy
            INNER JOIN buy ON receipt_buy.id_receipt_buy=buy.id_receipt_buy
...
<h5>
    ...
    <button type="button" class="btn btn-danger justify-content-flex-end" align="center">
                <a href="print/report_bill_buy_day.php?ds=<?php echo $ds; ?>&de=<?php echo $de; ?>" name="report" target="_Blank" class="text-white"><i class='fas fa-file-pdf'></i> </a></button>
                <button type="button" class="btn btn-success justify-content-flex-end" align="center">
                <a href="print/report_bill_buy_day.php?ds=<?php echo $ds; ?>&de=<?php echo $de; ?>" name="report" target="_Blank" class="text-white"><i class='fas fa-file-excel'></i> </a></button>
</h5>
</form></center>
<hr>
<?php $sql = "SELECT Count(receipt_buy.id_receipt_buy) AS Countbill_buy,Sum(buy.buy_number) AS buy_number,
                                Sum(buy.price_buy) AS price_buy,Sum(buy.total_buy) AS total_buy
                                FROM receipt_buy 
                                INNER JOIN buy ON receipt_buy.id_receipt_buy=buy.id_receipt_buy
                                AND date_receipt_buy BETWEEN '$ds 00:00:00.000000'
                                AND '$de 23:59:59.000000'";
...
<div class="col-xl-12 col-lg-7">
    <div class="card shadow mb-4">
        ...
        <div
            ...
            <h5 class="m-0 font-weight-bold "><font color="#000">ยอดการซื้อ</font></h5>
        </div>
        <!-- Card Body -->
        <div class="card-body " >
            <div class="chart-area" >
                ...
                <canvas id="buy" width="800px" height="330px"></canvas>
                <script>

	...
	include("/xampp/htdocs/project/condb/condb.php");
	   ?>
		...
		<div class="container-fluid bg-info">
			<h1 class="text-white">เพิ่มสินค้า</h1>
		</div>
		...
		<form action="add.php" method="post">
			...
			<input type="text" class="form-control" id="id_type_product" name="id_type_product">
			...
			<a href="add.php"><button type="submit" class="btn btn-warning">OK</button></a>
			<hr>
		</form>	
			<a href="product.php"><button type="submit" class="btn btn-info">กลับสู่หน้า สินค้า</button></a>
		</div>
	</body>
</html>
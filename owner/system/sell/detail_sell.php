...
<body id="page-top">
   ...
   <hr class="sidebar-divider">
    ...
    ?>   
            ...
            <thead >
                <tr class="bg-primary " >
                    <th><center><font color=#FFFFFF>ลำดับ</font></center></th>
                    <th><center><font color=#FFFFFF>เลขที่ใบเสร็จขาย</font></center></th>
                    <th><center><font color=#FFFFFF>รหัสสินค้า</font></center></th>
                    <th><center><font color=#FFFFFF>จำนวน</font></center></th>
                    <th><center><font color=#FFFFFF>ราคา</font></center></th>
                    <th><center><font color=#FFFFFF>ราคารวม</font></center></th>
                    <th><center><font color=#FFFFFF>สถานะ</font></center></th>
                    <th><center><font color=#FFFFFF>แก้ไข</font></center></th>
                    <th><center><font color=#FFFFFF>ลบ</font></center></th>
                </thead>
            <tbody>
            <?php
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                          <td><center><?php echo $row['no_sell']; ?></center></td>
                          <td><center><?php echo $row['id_receipt_sell']; ?></center></td>
                          <td><center><?php echo $row['id_product']; ?></center></td>
                          <td><center><?php echo $row['sell_number']; ?></center></td>
                          <td><center><?php echo $row['price_sell']; ?></center></td>
                          <td><center><?php echo $row['total_sell']; ?></center></td>
                          ...
                          <td><center><a href="delete.php?no_sell=<?php echo $row['no_sell']; ?>"><button type='button' class='btn btn-danger'>Delete</button></a></center></td>
                     ...
                     <?php endwhile ?>
                                        ...
                                        <center><a href="/project/owner/system/sell/sell.php" class="btn btn-warning" type="button" style="width:13%">กลับ</a></center>
                                        <br>
    </div>
                                </div>

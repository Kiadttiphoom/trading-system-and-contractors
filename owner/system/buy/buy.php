           ...
           <!--  <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/project/owner/system/delivery/delivery.php">
                    <i class="fa fa-truck" aria-hidden="true"></i>
                    <span>อนุมัติการส่งสินค้าสินค้า</span></a>
            </li>
    ...
    ?>   
            ...
            <thead >
                <tr class="bg-primary " >
                    ...
                    <th><center><font size=2 color=#FFFFFF>วันที่ซื้อ</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>เวลาที่ซื้อ</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>สถานะ</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>รายละเอียด</font></center></th>
                </thead>
            <tbody>
            <?php
                    $sql = " SELECT * FROM receipt_buy ";
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                          ...
                          <td><center><font size=2 color=><?php echo $row['id_receipt_buy']; ?></font></center></td>
                          <td><center><font size=2 color=><?php echo $row['id_employee']; ?></font></center></td>
                          <td><center><font size=2 color=><?php echo $row['id_company']; ?></font></center></td>
                          <td><center><font size=2 color=><?php echo $row['date_receipt_buy']; ?></font></center></td>
                          <td><center><font size=2 color=><?php echo $row['time_receipt_buy']; ?></font></center></td>
                          <td><center><font size=2 color=><?php echo $row['status']; ?></font></center></td>
                          
                          <td><center><a href="detail_buy.php"><button type="button" class="btn btn-success btn-sm"

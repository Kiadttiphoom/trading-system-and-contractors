                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">ข้อมูลซื้อสินค้า</h6>
    ...
    ?>   
            ...
            ?>    
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                        <td><center><font size=2><?php echo $row['no_buy']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['id_receipt_buy']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['id_product']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['buy_number']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['price_buy']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['total_buy']; ?></font></center></td>
                          ...
                          <a href="delete.php?no_buy=<?php echo $row['no_buy']; ?>"><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
                     ...
                     <?php endwhile ?>
                                        ...
                                        <center><a href="/project/owner/system/buy/buy.php" class="btn btn-success" type="button" style="width:13%">กลับ</a></center>
                                        <br>
    </div>
                                </div>

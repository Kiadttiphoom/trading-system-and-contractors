                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">การอนุมัติการสั่งซื้อ</h6>
    ...
    ?>   
            ...
            <thead >
                <tr class="bg-primary " >
                    ...
                    <th><center><font size=2 color=#FFFFFF>อนุุมัติการซื้อ</font></center></th>
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                          ...
                          <td><center><font size=2><button type="button" class="btn btn-success btn-sm"
                                                                        ...
                                                                        data-bs-target="#"><i
                                                                         class='fa fa-info-circle '></i> รายละเอียด</button></font></center></td>
                          <td><center><font size=2></font></center></td>
                          <td><center><font size=2></font></center></td>

   ...
   <hr class="sidebar-divider">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form id="frmMain" name="frmMain" method="post" action="save_buy.php" style="" class="text-center mt-5" >
                    ...
                    <center><div class="card shadow mb-4" style="width:80%">
                        ...
                        <center><table border="0" style="width:90%">
                            <tr>
                                <td class="text-right">วันที่ <?php echo $date_receipt_buy; ?></td>   
                            </tr>
                            <tr>
                                <td class="text-right">เวลา <?php echo $time_receipt_buy; ?></td>
                            </tr>
                            </table></center>         
                        ...
                        $(document).ready(function(){
                            ...
                            $("#createRows").click(function(){
                                                ...
                                                rows = rows + 1;
                                                    ...
                                                    <center><table border="1" id="myTable" style="width:90%" >
                            <tr>
                            ...
                            <td><input name="total_buy" type="text" id="total_buy"  class="form-control text-center" placeholder=""   readonly style="width:"/></td> 

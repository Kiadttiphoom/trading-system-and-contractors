  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form name="addcustomer" method="post" action="save_customer.php" style="width: 100%; margin: 0 auto;" class="text-center mt-5">
            ...
            <div class="form-group">
                <div><center><textarea input class="form-control text-center" name="address_customer" type="text" id="address_customer" class="form-control" placeholder="ที่อยู่" aria-describedby="text" required style="width:80%"></textarea></center>
                </div>
            </div>

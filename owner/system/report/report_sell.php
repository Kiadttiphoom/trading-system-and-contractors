        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">รายงานการขาย</h6>
                ...
                <div class="table-responsive">
                    ...
                    <center>
                    <input type="radio" id="รายวัน" name="fav_language" value="รายวัน">
  <label for="html">รายวัน</label>
  <input type="radio" id="รายเดือน" name="fav_language" value="รายเดือน">
  <label for="css">รายเดือน</label>
  <input type="radio" id="กำหนดเอง" name="fav_language" value="กำหนดเอง">
  <label for="javascript">กำหนดเอง</label>
                    <span>
    ...
    <button type='button' class='btn btn-Secondary'>ค้นหา</button>
            ...
            <thead >
                <tr class="bg-primary " >
                <th><center><font color=#FFFFFF>ลำดับที่</font></center></th>
                    ...
                    <th><center><font size=2 color=#FFFFFF>รายการ</font></center></th>
                    ...
                    <th><center><font size=2 color=#FFFFFF>ภาษี</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>ราคารวมหลังภาษี</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>เวลา</font></center></th>
            ...
            <tbody>
                      ...
                      <tr>
                          ...
                          <td><center></center></td>
                          <td><center></center></td>
                          <td><center><button type="button" class="btn btn-success btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#"><i
                                                                         class='fa fa-info-circle '></i> รายละเอียด</button>
                                                                    
                                                                    <button type="button" class="btn btn-primary btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#"><i
                                                                         class='fas fa-print'></i> พิพม์</button>
                                                                    ...
                                                                    <button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data<?php echo $row['Billbuy_no']; ?>"><i
                                                                    ...
                                                                    <button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#delete_data<?php echo $row['Billbuy_no']; ?>"><i
                                                                            class='fas fa-trash-alt'></i> ลบ</button>
                                                                    <div class="modal fade"
                                                                        id="delete_data<?php echo $row['Billbuy_no']; ?>"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <button type="button"
                                                                                        ...
                                                                                        onclick="window.location.href='sell-buy/delbillbuy.php?Billbuy_no=<?php echo $row['Billbuy_no']; ?>'">ยืนยัน</button>
                                                                                    <button type="button"

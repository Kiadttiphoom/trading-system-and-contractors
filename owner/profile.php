       ...
       <!--    <li class="nav-item">
           ...
           <!--  <li class="nav-item">
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapseone" class="collapse" aria-labelledby="headingone" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/project/owner/report_buy.php">Report การซื้อสินค้า</a>
                        <a class="collapse-item" href="/project/owner/report_sell.php">Report การขายสินค้า</a>
                        <a class="collapse-item" href="/project/owner/report_delivery.php">Report การส่งสินค้า</a>
                        <a class="collapse-item" href="/project/owner/report_inout_product.php">Report การเข้าออกสินค้า</a>
                        <a class="collapse-item" href="/project/owner/report_contractor.php">Report การรับเหมา</a>
                    </div>
                </div>
            </li> -->
            ...
            <a class="dropdown-item" href="/project/login.php" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                            ...
                            <div
                                    ...
                                    <center><h5 class="m-0 font-weight-bold text-primary"><font color=#000>ข้อมูลส่วนตัว</font></h5></center>                           
                                </div>
                                <!-- Card Body -->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form name="password_edit" > 
            ...
            <br><center><label class="form-label" for="form3Example3"><font color="#000"><b>รหัสผ่านเก่า</b></font></label></center>
            <center><input style="width:50%" name="oldpassword" class="form-control" type="password" id="oldpassword" value=""></center>
        
              <br><center><label class="form-label" for="form3Example3"><font color="#000"><b>รหัสผ่านใหม่</b></font></label></center>
              <center><input style="width:50%" name="password" class="form-control" type="password" id="password" value=""></center>
                
            <br><center><label class="form-label" for="form3Example3"><font color="#000"><b>ยืนยันรหัสผ่านใหม่</b></font></label></center>
            <center><input style="width:50%" name="conpassword" class="form-control" type="password" id="conpassword" value=""></center>

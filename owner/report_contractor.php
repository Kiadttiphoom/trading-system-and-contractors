    ...
    <div class="col-xl-12 col-lg-1">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <h5 class="m-0 font-weight-bold "><font color="#000">รายงานการรับเหมา</font></h5>
            </div>
            
            <!-- Card Body -->
            <div class="container col-lg-10 py-2 justify-content-center">
                <div class="row justify-content-center">
                <div class="row mb-2 pb-0 border-bottom justify-content-center">
                   ...
                   <?php
                        $act = (isset($_GET['act']) ? ($_GET['act']) : '');
                            ...
                            include('chartcontractor/charts_rangedate.php');

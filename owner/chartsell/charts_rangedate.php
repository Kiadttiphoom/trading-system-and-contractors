    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">รายงานการขายสินค้า</h4>
            </div>
                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <thead>
                            <tr class="bg-secondary ">
                                ...
                                <th width="15%">
                                    <center>
                                        <font color=#FFFFFF size="2">ชื่อบริษัท</font>
                                    </center>
                                </th>
                                <th>
                                    <center>
                        ...
                        <tbody>
                           ...
                           $result = $objCon->query($sql);?>
                            ...
                            <tr>
                                <td name="a[]">
                                    <center><font size="2" color="#000"><b><?php echo $row['id_receipt_sell']; ?></b></font></center>
                                </td>
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['date_receipt_sell']."  ".$row['time_receipt_sell']; ?></b></font></center>
                                </td>
                                <td>
                                ...
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['sell_number']; ?></b></font></center>
                                </td>
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['price_sell']; ?></b></font></center>
                                </td>
                                <td>
                                    <center><font size="2" color="#000"><b><?php echo $row['total_sell']; ?></b></font></center>
                                </td>
                               
                            </tr>
                            
                            <?php @$amount_total += $row['total_sell']; ?>
                            <?php endwhile ?>
                            <tr>
...
<!-- Select report sell day -->
<?php


            $query = "SELECT Sum(sell.total_sell) AS total_sell, DATE_FORMAT(date_receipt_sell, '%d-%M-%Y') AS datesave
            FROM receipt_sell
            INNER JOIN sell ON receipt_sell.id_receipt_sell=sell.id_receipt_sell
...
<h5>
    ...
    <button type="button" class="btn btn-danger justify-content-flex-end" align="center">
                <a href="print/report_bill_sell_day.php?ds=<?php echo $ds; ?>&de=<?php echo $de; ?>" name="report" target="_Blank" class="text-white"><i class='fas fa-file-pdf'></i> </a></button>
                <button type="button" class="btn btn-success justify-content-flex-end" align="center">
                <a href="print/report_bill_sell_day.php?ds=<?php echo $ds; ?>&de=<?php echo $de; ?>" name="report" target="_Blank" class="text-white"><i class='fas fa-file-excel'></i> </a></button>
</h5>
</form></center>
<hr>
<?php $sql = "SELECT Count(receipt_sell.id_receipt_sell) AS Countbill_sell,Sum(sell.sell_number) AS sell_number,
                                Sum(sell.price_sell) AS price_sell,Sum(sell.total_sell) AS total_sell
                                FROM receipt_sell 
                                INNER JOIN sell ON receipt_sell.id_receipt_sell=sell.id_receipt_sell
                                AND date_receipt_sell BETWEEN '$ds 00:00:00.000000'
                                AND '$de 23:59:59.000000'";
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <?php echo @$row['Countbill_sell']; ?> รายการ
                    </div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-calendar fa-2x text-gray-300"></i>
                                ...
                                <!-- Show Fresh latex -->
                                <div class="col-xl-3 col-md-6 mb-4 btn" data-bs-toggle="modal" data-bs-target="#sell_day">
...
<div class="col-xl-12 col-lg-7">
    <div class="card shadow mb-4">
        ...
        <div
            ...
            <h5 class="m-0 font-weight-bold "><font color="#000">ยอดการขาย</font></h5>
        </div>
        <!-- Card Body -->
        <div class="card-body">
            <div class="chart-area">
                ...
                <canvas id="sell" width="800px" height="330px"></canvas>
                <script>

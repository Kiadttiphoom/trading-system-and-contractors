        ...
        <h2>แก้ไขข้อมูลสมาชิก</h2><br>
            ...
            <div class="row mb-4">
                <div class="col">
                    ...
                    <br><label class="form-label" for="form3Example1"><h5><font color=#000000>อายุ</font></h5></label>
            <input name="txtage" type="text" id="txtage" value="<?php echo $objResult["age"];?>">
                    
                </div>
                <div class="col">
                    
                    <br><label class="form-label" for="form3Example1"><h5><font color=#000000>เพศ</font></h5></label>
                    ...
                    <input name="txttel" type="text" id="txttel" value="<?php echo $objResult["tel"];?>"><br>
                    
                    <br><br><label class="form-label" for="form3Example1"><h5><font color=#000000>อีเมล์</font></h5></label>
                    <input name="txtemail" type="email" id="txtemail" value="<?php echo $objResult["email"];?>"><br>
            ...
            <!-- Submit button -->
            <br><button type="submit" name="submit" value="Save" class="btn btn-primary btn-block mb-4">แก้ไข</button>

...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2022 at 09:35 PM
...
INSERT INTO `buy` (`no_buy`, `id_receipt_buy`, `id_product`, `buy_number`, `price_buy`, `price_sell`, `total_buy`, `status`) VALUES
(13, 'B0005', 'A001', 5, 10, 0, 50, '1'),
(14, 'B0005', 'A002', 4, 10, 0, 40, '1'),
(15, 'B0006', 'A008', 8, 200, 0, 1600, '1'),
(25, 'B0007', 'A001', 20, 10, 0, 200, '1'),
(26, 'B0007', 'A002', 20, 10, 0, 200, '1'),
(27, 'B0007', 'A007', 20, 10, 0, 200, '1'),
(28, 'B0007', 'A008', 20, 10, 0, 200, '1');
...
('F01', 'ห้างหุ้นส่วนจำกัด อังเจียมอะลูมิเนียม ', '074262860', '1', '1', '100102', 10200, 'ซอย 4', 'aluminumsirisuwan@gmail.com'),
('F02', 'ห้างหุ้นส่วนจำกัด อังเจียมอะลูมิเนียม 2', '088888822', '4', '66', '130101', 12000, '25/1 ซอย 1', 'aluminumsirisuwan2@gmail.com'),
('F03', 'ห้างหุ้นส่วนจำกัด อังเจียมอะลูมิเนียม 3', '0888888888', '8', '110', '170201', 16130, '1212', 'aluminumsirisuwan3@gmail.com');
...
CREATE TABLE `contractor` (
  ...
  `contractor_number` varchar(3) NOT NULL,
  `total_contractor` int(7) NOT NULL,
  `status` varchar(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(19, 'T0001', 'w1', 1, 2, '1', 7000, '2'),
(20, 'T0001', 'w2', 2, 1, '1', 5000, '2'),
(21, 'T0002', 'w1', 1, 2, '1', 7000, '2'),
(22, 'T0002', 'w2', 2, 1, '1', 6000, '2');
...
('C001', 'นาย', 'อโนทัย บ้านรึงรัง', '0888888889', '120202', '59', '3', 11130, 'หมู่ 3 หมู่บ้าน สังแคบ', 'anothai@gmail.com'),
('C002', 'นาย', 'เกียรติภูมิ บู่เอียด', '0630907500', '150101', '90', '6', 14000, '21', ''),
('C003', 'นาย', 'เกียรติภูมิ บู่เอียด', '0981234567', '200303', '138', '11', 20190, 'ใมใม', ''),
('C004', 'นาย', 'เกียรติภูมิ บู่เอียด', '0981234567', '100101', '1', '1', 10200, '25/1', ''),
('C005', 'นาย', 'เกียรติภูมิ บู่เอียด', '0888888888', '100101', '1', '1', 10200, '211212', ''),
('C006', 'นาย', 'เกียรติภูมิ บู่เอียด', '0630907500', '130403', '69', '4', 12170, '25/1 ซอย 4', 'kiadttiphoom27@gmail.com');
...
CREATE TABLE `delivery` (
  ...
  `price_delivery` varchar(2) NOT NULL,
  `total_delivery` int(5) NOT NULL,
  `status` varchar(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(12, 'SA0005', 'A001', 2, '10', 20, '1'),
(13, 'SA0005', 'A002', 5, '10', 50, '1'),
(14, 'SA0007', 'A001', 5, '10', 50, '1'),
(15, 'SA0007', 'A002', 4, '10', 40, '1');

-- --------------------------------------------------------

--
-- Table structure for table `detail_quotation`
--

CREATE TABLE `detail_quotation` (
  `no_quotatiob` int(4) NOT NULL,
  `id_quotation` varchar(20) NOT NULL,
  `id_employee` varchar(4) NOT NULL,
  `id_custumer` varchar(4) NOT NULL,
  `detail_quotation` varchar(1000) NOT NULL,
  `quantity_quotation` int(4) NOT NULL,
  `unit_quotation` int(4) NOT NULL,
  `unit_price_quotation` int(4) NOT NULL,
  `total_price_quotation` int(7) NOT NULL,
  `baht_text_quotation` varchar(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(17, 'นาย', 'SF2', 'e10adc3949ba59abbe56e057f20f883e', 'สมหมาย ขายสี', '0891234567', '101302', '13', '1', 10100, 'ซอย 4', 'somchai2@gamil.com', 'Admin'),
(18, 'นาย', 'SF1', 'e10adc3949ba59abbe56e057f20f883e', 'สมหมาย ขายของ', '0865412547', '120403', '61', '3', 11110, 'ซอย4', 'sommai@gmail.com', 'Employee'),
(19, 'นาย', 'SF3', 'e10adc3949ba59abbe56e057f20f883e', 'ขายดี ซื้อดี', '0835412657', '900102', '918', '70', 90000, '7', 'kaidee@gmail.com', 'Owner'),
(20, 'นาย', 'SF4', 'e10adc3949ba59abbe56e057f20f883e', 'สมชาย ดีมาก', '0985478562', '100303', '3', '1', 10530, '77', 'somchai@gmail.com', 'Employee');
...
INSERT INTO `product` (`no_product`, `id_product`, `name_product`, `price_sell`, `id_unit`, `id_type_product`) VALUES
(1, 'A001', 'กล่องเรียบ สีบรอนด์ 1 มม.', 100, 'U1', 'T1'),
(2, 'A002', 'กล่องร่อง สีบรอนด์ 1 มม.', 120, 'U1', 'T1'),
(3, 'A003', 'กล่องเปิด สีบรอนด์ 1 มม.', 150, 'U1', 'T1'),
(4, 'A004', 'ฝาปิด สีบรอนด์ 1 มม.', 200, 'U1', 'T1'),
(5, 'A005', 'กล่องแจ๊คสัน สีบรอนด์ 1 มม.', 300, 'U1', 'T1'),
(6, 'A006', 'ฝาแจ็คสัน สีบรอนด์ 1 มม.', 350, 'U1', 'T1'),
(7, 'A007', 'เสาสวิง สีบรอนด์ 1 มม.', 400, 'U1', 'T1'),
(29, 'A008', 'รางแขวน สีบรอนด์ 1 มม.', 200, 'U1', 'T1'),
(30, 'A009', 'เฟรมข้างบานเลื่อน สีบรอนด์ 1 มม.', 200, 'U1', 'T1');
...
('B0005', 'SF1', 'F01', '2022-11-29', '18:59:32', '90', '1'),
('B0006', 'SF1', 'F01', '2022-11-30', '16:16:05', '1600', '1'),
('B0007', 'SF1', 'F01', '2022-12-02', '03:28:34', '800', '1');
...
CREATE TABLE `receipt_contractor` (
  ...
  `grand_contractor` int(7) NOT NULL,
...
('T0001', 'A001', 'C001', 'สงขลา', '.................................', 12000, '2022-11-30', '22:44:58', '2'),
('T0002', 'E001', 'C001', 'สงขลา', '.....................................', 13000, '2022-12-01', '22:26:06', '2');
...
CREATE TABLE `receipt_delivery` (
  ...
  `grand_delivery` varchar(7) NOT NULL,
  `status` varchar(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
('SA0005', 'SF1', 'C001', 'สงขลา', '2022-12-01', '02:54:25', '70', '1'),
('SA0007', 'SF1', 'C001', '', '2022-12-02', '02:13:07', '90', '1');
...
('SA0001', 'SF1', 'C001', '2022-11-01', '23:34:34', '100', '1'),
('SA0002', 'SF1', 'C001', '2022-11-01', '23:35:16', '20', '1'),
('SA0003', 'SF1', 'C001', '2022-11-29', '19:00:36', '110', '1'),
('SA0004', 'SF1', 'C001', '2022-11-29', '19:04:39', '50', '1'),
('SA0005', 'SF1', 'C001', '2022-12-01', '02:54:25', '70', '1'),
('SA0006', 'SF1', 'C001', '2022-12-01', '22:25:48', '90', '1'),
('SA0007', 'SF1', 'C001', '2022-12-02', '02:13:07', '90', '1');
...
(1, 'SA0001', 'A001', 5, 10, 50, '1'),
(2, 'SA0001', 'A007', 5, 10, 50, '1'),
(3, 'SA0002', 'A002', 2, 10, 20, '1'),
(8, 'SA0003', 'A008', 11, 10, 110, '1'),
(9, 'SA0004', 'A001', 5, 10, 50, '1'),
(17, 'SA0005', 'A001', 2, 10, 20, '1'),
(18, 'SA0005', 'A002', 5, 10, 50, '1'),
(19, 'SA0006', 'A001', 5, 10, 50, '1'),
(20, 'SA0006', 'A002', 4, 10, 40, '1'),
(21, 'SA0007', 'A001', 5, 10, 50, '1'),
(22, 'SA0007', 'A002', 4, 10, 40, '1');
...
--
ALTER TABLE `buy`
  MODIFY `no_buy` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `contractor`
--
ALTER TABLE `contractor`
  MODIFY `no_contractor` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `delivery`
--
ALTER TABLE `delivery`
  MODIFY `no_delivery` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `employee`
--
ALTER TABLE `employee`
  MODIFY `id_employee` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `product`
  MODIFY `no_product` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `sell`
  MODIFY `no_sell` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

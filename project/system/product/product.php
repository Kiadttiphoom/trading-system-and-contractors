...
<!-- Sidebar Message -->
    ...
    ?>   
            ...
            ?>   
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                        <td><center><font size=2><?php echo $row['id_product']; ?></font></center></td>
                          ...
                          <td><center><font size=2><a href='edit_product.php?id_product=<?php echo $row['id_product']; ?>&name_product=<?php echo $row['name_product']; ?>&id_type_product=<?php echo $row['id_type_product']; ?>'><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                            class='fas fa-edit'></i> แก้ไข</button></a></font>
                        <font size=2><a href='delete_product.php?id_product=<?php echo $row['id_product']; ?>'><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
                 ...
                 <center><button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"> เพิ่มข้อมูลสินค้า</button></center>
                ...
                <form name="addproduct" method="post" action="save_product.php" style="width: 100%; margin: 0 auto;" class="text-center mt-5">
        <div class="card">
                <br>
        <div class="container">
        <br>
        <h2>เพิ่มข้อมูลสินค้า</h2><br>
        
            <!-- 2 column grid layout with text inputs for the first and last names -->
            
                    
                <input name="id_product" type="text" id="id_product" class="form-control" placeholder="รหัสสินค้า" required/><br>
                <label class="form-label" for="form1Example1"></label>        
            
                <input name="name_product" type="text" id="name_product" class="form-control" placeholder="ชื่อสินค้า" required/><br>
                <p>ประเภทสินค้า<p>
                <select class="id_type_product form-control text-center" style="width:100%" id="id_type_product" name="id_type_product">
                                    <?php
            ...
            <br><br>
            <button type="submit" name="submit" value="Save" class="btn btn-success btn-block mb-4">เพิ่มข้อมูลสินค้า</button>
            <a class="btn btn-primary btn-block mb-4" href="product.php">กลับ</a>
            </div>
            </div>
     </form>
      <div>

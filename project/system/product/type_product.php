...
<!-- End of Sidebar -->
                ...
                <div class="container-fluid">
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">ข้อมูลประเภทสินค้า</h6>
    ...
    ?>   
            ...
            <thead >
                <tr class="bg-primary " >
                    <th><center><font size=2 color=#FFFFFF>รหัสประเภทสินค้า</font></center></th>
                    <th><center><font size=2 color=#FFFFFF>ชื่อประเภทสินค้า</font></center></th>
            ...
            ?>   
                     ...
                     <?php while($row = $result->fetch_assoc()): ?>
                      <tr>
                        <td><center><font size=2><?php echo $row['id_type_product']; ?></font></center></td>
                          <td><center><font size=2><?php echo $row['name_type_product']; ?></font></center></td>
                          <td><center><font size=2><a href='edit_type_product.php?id_type_product=<?php echo $row['id_type_product']; ?>&name_type_product=<?php echo $row['name_type_product']; ?>'><button type="button" class="btn btn-warning btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#edit_data"><i
                                                                            class='fas fa-edit'></i> แก้ไข</button></a></font>
                        <font size=2><a href='delete_type_product.php?id_type_product=<?php echo $row['id_type_product']; ?>'><button type="button" class="btn btn-danger btn-sm"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#delete_data"><i
                                                                            class='fas fa-trash-alt'></i> ลบ</button></a></center></font></td>
                       </tr>
                     <?php endwhile ?>
                    </tbody>
                 ...
                 <center><button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal"> เพิ่มข้อมูลประเภทสินค้า</button></center>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form name="addtypeproduct" method="post" action="save_type_product.php" style="width: 100%; margin: 0 auto;" class="text-center mt-5">
        <div class="card">
                <br>
        <div class="container">
        <br>
        <h2>เพิ่มข้อมูลประเภทสินค้า</h2><br>
        
            <!-- 2 column grid layout with text inputs for the first and last names -->
            
                    
                <input name="id_type_product" type="text" id="id_type_product" class="form-control" placeholder="รหัสประเภทสินค้า" required/><br>
                <label class="form-label" for="form1Example1"></label>        
            
                <input name="name_type_product" type="text" id="name_type_product" class="form-control" placeholder="ชื่อประเภทสินค้า" required/><br>


            <!-- Submit button -->

            <br><br>
            <button type="submit" name="submit" value="Save" class="btn btn-success btn-block mb-4">เพิ่มข้อมูลประเภทสินค้า</button>
            <a class="btn btn-primary btn-block mb-4" href="type_product.php">กลับ</a>
            </div>
            </div>
     </form>
      <div>

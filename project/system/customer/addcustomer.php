...
<form name="addcustomer" method="post" action="save_customer.php" style="width: 50%; margin: 0 auto;" class="text-center mt-5">
            ...
            <!-- 2 column grid layout with text inputs for the first and last names -->
             ...
             <div class="form-group">
                 <div><center><input class="form-control text-center" name="id_customer" value="<?php echo $id_customer; ?>" type="text" id="id_customer"  readonly aria-describedby="text" required style="width:50%"/></center>
                </div>
            </div>
            
            
            <div class="form-group">
                <div><center><input class="form-control text-center" name="name_customer" type="text" id="name_customer" class="form-control" placeholder="ชื่อลูกค้า" aria-describedby="text" required style="width:50%"/></center>
                </div>
            </div>
            
            
            <div class="form-group">
                <div><center><input class="form-control text-center" name="tel_customer" type="text" id="tel_customer" class="form-control" placeholder="เบอร์โทรศัพท์" aria-describedby="text" required style="width:50%"/></center>
                </div>
            </div>
            
            <div class="form-group">
                <div><center><textarea input class="form-control text-center" name="address_customer" type="text" id="address_customer" class="form-control" placeholder="ที่อยู่" aria-describedby="text" required style="width:50%"></textarea></center>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/project/login-register/login.php">ออกระบบ</a>
                </div>
            </div>
        </div>
    </div>

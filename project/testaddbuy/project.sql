...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2022 at 02:19 PM
...
CREATE TABLE `buy` (
  ...
  `id_receipt_buy` varchar(5) NOT NULL,
...
(8, 'B0001', 'A003', 1, 100, 0, 100, ''),
(9, 'B0002', 'A002', 1, 100, 0, 100, ''),
(11, 'B0003', 'A002', 1, 100, 0, 100, ''),
(12, 'B0003', 'A003', 1, 100, 0, 100, '');
...
INSERT INTO `company` (`id_company`, `name_company`, `tel_company`, `address_company`) VALUES
('F01', 'ห้างหุ้นส่วนจำกัด อังเจียมอะลูมิเนียม', '074262860', '620 รัถการ อำเภอหาดใหญ่ สงขลา 90110');
...
CREATE TABLE `contractor` (
  ...
  `id_contractor` varchar(5) NOT NULL,
...
INSERT INTO `contractor` (`no_contractor`, `id_contractor`, `id_type_work`, `width_contractor`, `hight_contractor`, `contractor_number`, `status`) VALUES
(7, 'T001', 'w1', 1, 2, '1', ''),
(8, 'T001', 'w2', 2, 1, '1', '');
...
INSERT INTO `customer` (`id_customer`, `prefix_name`, `name_customer`, `tel_customer`, `province`, `amphure`, `district`, `address_customer`) VALUES
('C001', '          ', 'อโนทัย บ้านสวรรค์                                 ', '0888888888', '60        ', '                    ', '                    ', 'ปัตตานี'),
('C002', '', 'อโนทัย บ้านปฐม', '0630907500', '', '', '', 'สงขลา'),
('C003', '', 'อโนทัย บ้านสงขลา', '0888888888', '', '', '', 'ยะลา'),
('C007', 'นาง       ', 'อโนทัย บ้านสวรรค์                                 ', '0888888888', '70        ', '900102              ', '918                 ', '22');
...
(2, 'A001', '123456', 'สมหมาย ขายสี', '0887788996', 'สงขลา', 'Admin'),
(3, 'E001', '123456', 'สมชาย ขายดินสอ', '0778899663', 'ยะลา', 'Employee'),
(4, 'O001', '123456', 'สมหญิง ขายยางลบ', '0996663332', 'ตรัง', 'Owner'),
(5, 'O002', '123456', 'สมหมี ขายดี', '0849541236', 'พัทลุง', 'Owner'),
(6, 'E002', '123456', 'สมปรอง', '0887788100', 'ภูเก็ต', 'Employee'),
(13, 'E003', '123456', 'มานะ มาชัย', '0897788996', 'สงขลา', 'Employee'),
(14, 'A002', '123456', 'สมศรี ขายข้าว', '0890242568', 'สงขลา', 'Employee'),
(15, 'A003', '123456', 'นาย ก', '123456', 'สงขลา', 'Employee');
...
CREATE TABLE `product` (
  ...
  `id_type_product` varchar(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `product` (`no_product`, `id_product`, `name_product`, `id_type_product`) VALUES
(2, 'A002', 'กล่องร่อง สีบรอนด์ 1 มม.', 'A'),
(3, 'A003', 'กล่องเปิด สีบรอนด์ 1 มม.', 'A'),
(4, 'A004', 'ฝาปิด สีบรอนด์ 1 มม.', 'A'),
(5, 'A005', 'กล่องแจ๊คสัน สีบรอนด์ 1 มม.', 'A'),
(6, 'A006', 'ฝาแจ็คสัน สีบรอนด์ 1 มม.', 'A'),
(17, 'A007', 'เสาสวิง สีบรอนด์ 1 มม.', 'A');
...
INSERT INTO `receipt_buy` (`id_receipt_buy`, `id_employee`, `id_company`, `date_receipt_buy`, `time_receipt_buy`, `status`) VALUES
('B0001', 'E001', 'F01', '2022-09-20', '04:29:37', ''),
('B0002', 'E001', 'F01', '2022-09-20', '04:42:33', ''),
('B0003', 'E001', 'F01', '2022-09-24', '17:56:13', '');
...
INSERT INTO `receipt_contractor` (`id_contractor`, `id_employee`, `id_customer`, `address_contractor`, `detail_contractor`, `total_contractor`, `date_receipt_contractor`, `time_receipt_contractor`, `status`) VALUES
('T001', 'E001', 'C001', 'สงขลา', '..................', 10000, '2022-09-19', '20:22:50', '');
...
CREATE TABLE `receipt_sell` (
  `id_receipt_sell` varchar(5) NOT NULL,
  `id_employee` varchar(4) NOT NULL,
  `id_customer` varchar(4) NOT NULL,
...
INSERT INTO `receipt_sell` (`id_receipt_sell`, `id_employee`, `id_customer`, `date_receipt_sell`, `time_receipt_sell`, `status`) VALUES
('S0001', 'E001', 'C001', '2022-09-19', '19:51:25', '');
...
(1, 'S0001', 'A001', 11, 3, 33, ''),
(2, 'S0001', 'A001', 11, 10, 110, '');
...
CREATE TABLE `type_work` (
  `id_type_work` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `name_type_work` varchar(50) COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `work` (
  ...
  `id_type_work` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `id_product` varchar(5) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `buy`
  MODIFY `no_buy` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `contractor`
--
ALTER TABLE `contractor`
  MODIFY `no_contractor` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `employee`
  MODIFY `id_employee` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `product`
  MODIFY `no_product` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `sell`
  MODIFY `no_sell` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

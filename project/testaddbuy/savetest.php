...
<?php
	...
	for($i=1;$i<=$_POST["hdnCount"];$i++)
	{
			...
			$strSQL = "INSERT INTO buy ";
			$strSQL .="(id_receipt_buy,id_product,buy_number,price_buy,total_buy) ";
			$strSQL .="VALUES ";
			$strSQL .="('".$_POST["id_receipt_buy"]."','".$_POST["id_product$i"]."', ";
			$strSQL .="'".$_POST["buy_number$i"]."' ";
			$strSQL .=",'".$_POST["price_buy$i"]."','".$_POST["total_buy$i"]."', ";
